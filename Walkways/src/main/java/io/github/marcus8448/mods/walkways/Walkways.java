...
public class Walkways implements ModInitializer {
    public static final Block WALKWAY = new WalkwayBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool());
    public static final Block MOVING_WALKWAY = new MovingWalkwayBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool());
